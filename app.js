...
function randomIndex(str){
  ...
  generateEl.addEventListener(`click`, () => {
    ...
    // The generatePassword function takes the true/false values determined by the checkboxes as well as the number from the number input as argument and returns a string (AKA The generated password) which is set as the value for the innterText property for the result element/span
  ...
  clipboardEl.addEventListener(`click`, () => {
    ...
    // Adding the text area to the webpage
    body.append(textArea);
    // Selecting the value inside the textarea
    textArea.select();
    // Copying selected value
    document.execCommand(`copy`);
    // Removing the textarea element from the webpage
    textArea.remove();
    alert(`Password has been copied to the clipbaord!`);
  });